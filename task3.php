<?php
   ...
   require_once "ghaidaa_db\database.php";
?>
...
<label for="forwards">forward:</label><br>
...
if(isset($_POST['SAVE'])){
$result = 'R';
$sql = "INSERT INTO`MOVE_INFO`('left','right','forward','backward','stop') VALUES('$LEFT','$RIGHT','$FORWARDS','$BACKWARDS','$STOP')";
